...
// function myFunction() {
// gen=document.getElementById("text");
// words=gen.innerHTML="Hi my name is mohammed arbaaz"
// }
document.getElementById("btn").addEventListener("click", () => {
    let jokedisplay = Math.floor(Math.random() * jokes.length);
    document.getElementById("text").innerHTML = jokes[jokedisplay];
  })